...
class DeviceEnvironmentRepository @Inject constructor(
...
) : DeviceEnvironmentRepositoryPort {
    companion object {
     ...
     */
    override suspend fun hasRequiredStorage(requiredBytes: Long): Boolean {
        return try {
     ...
     */
    suspend fun hasRequiredStorage(): Boolean {
        return hasRequiredStorage(ModelConfig.REQUIRED_FREE_SPACE_BYTES)
    }
}
