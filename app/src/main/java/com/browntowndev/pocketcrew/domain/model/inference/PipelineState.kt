...
/**
 * Represents a single step in the Crew Mode pipeline.
...
/**
 * Domain state for the Crew Mode pipeline.
...
data class PipelineState(
    ...
    companion object {
        ...
        /**
         * Creates initial pipeline state for starting a Crew Mode conversation.
         */
